...
#define X_MAX_LENGTH 161
#define Y_MAX_LENGTH 161
#define Z_MAX_LENGTH 161 // Set this to your appx maximum Z height from home position to table measred from the nozzle tip.  You can fine-tune this with either the endstop screws or eeprom settings in Repetier Host
