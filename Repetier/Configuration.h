...
*/
    ...
    #define XAXIS_STEPS_PER_MM 100.00
    /** \brief Number of steps for a 1mm move in y direction.
    For xy gantry use 2*belt moved!
    Overridden if EEPROM activated.*/
    #define YAXIS_STEPS_PER_MM 100.00
    /** \brief Number of steps for a 1mm move in z direction  Overridden if EEPROM activated.*/
    #define ZAXIS_STEPS_PER_MM 100.00
#endif
...
//#define EXT0_STEPS_PER_MM 125
//#define EXT0_STEPS_PER_MM 290

// What type of sensor is used?4
// 1 is 100k thermistor (Epcos B57560G0107F000 - RepRap-Fab.org and many other)
// 2 is 200k thermistor2.4
...
//#define EXT0_MAX_ACCELERATION 9500
...
#define EXT0_PID_P   21.22
/** I-gain. Overridden if EEPROM activated. */
#define EXT0_PID_I  2.66
/** Dgain.  Overridden if EEPROM activated.*/
#define EXT0_PID_D 42.31
...
to 0 to disable.
*/
#define EXT0_WAIT_RETRACT_UNITS 	10
...
#define USER_THERMISTORTABLE1  {\
  {1*4,713*8},{54*4,236*8},{107*4,195*8},{160*4,172*8},{213*4,157*8},{266*4,144*8},{319*4,134*8},{372*4,125*8},{425*4,117*8},\
  {478*4,110*8},{531*4,103*8},{584*4,96*8},{637*4,89*8},{690*4,83*8},{743*4,75*8},{796*4,68*8},{849*4,59*8},{902*4,48*8},{955*4,34*8},\
  {1008*4,3*8} }
...
/** P-gain.  Overridden if EEPROM activated. */
#define HEATED_BED_PID_PGAIN   22.58
/** I-gain  Overridden if EEPROM activated.*/
#define HEATED_BED_PID_IGAIN   9.59
/** Dgain.  Overridden if EEPROM activated.*/
#define HEATED_BED_PID_DGAIN 13.35
// maximum time the heater is can be switched on. Max = 255.  Overridden if EEPROM activated.
...
#define X_MAX_LENGTH 160.7
#define Y_MAX_LENGTH 160.7
#define Z_MAX_LENGTH 160.7 // Set this to your appx maximum Z height from home position to table measred from the nozzle tip.  You can fine-tune this with either the endstop screws or eeprom settings in Repetier Host
...
/** \brief X, Y, Z max acceleration in mm/s^2 for printing moves or retracts. Make sure your printer can go that high! 
 Overridden if EEPROM activated.
*/
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_X 950
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Y 950
#define MAX_ACCELERATION_UNITS_PER_SQ_SECOND_Z 950

// X, Y, Z max acceleration in mm/s^2 for travel (non-printing) moves.  Overridden if EEPROM activated.
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_X 950
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Y 950
#define MAX_TRAVEL_ACCELERATION_UNITS_PER_SQ_SECOND_Z 950
...
#define UI_VERSION_STRING2 "Kossel"
